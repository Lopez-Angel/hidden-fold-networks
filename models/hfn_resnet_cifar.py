...
__all__ = [
    ...
    "cWideResNet50",
    "cResNet101",
    "HFN_cResNet50_3_4_ubn",
    "HFN_cResNet50_2_3_4_ubn",
    "HFN_cWideResNet50_3_4_ubn",
    "HFN_cResNet101_3_4_ubn",
    "HFN_cResNet152_3_4_ubn",
    "HFN_cResNet200_3_4_ubn",
]
...
def cResNet18():
    return HFN_cResNet(get_builder(), BasicBlock, None, [False, False, False, False], [2, 2, 2, 2])

def cResNet34():
    return HFN_cResNet(get_builder(), BasicBlock, None, [False, False, False, False], [3, 4, 6, 3])

def cResNet50():
    return HFN_cResNet(get_builder(), Bottleneck, None, [False, False, False, False], [3, 4, 6, 3])

def cWideResNet50():
    return HFN_cResNet(get_builder(), Bottleneck, None, [False, False, False, False], [3, 4, 6, 3], wider=2)

def cResNet101():
    return HFN_cResNet(get_builder(), Bottleneck, None, [False, False, False, False], [3, 4, 23, 3])


## Folded/HFN models
def HFN_cResNet50_3_4_ubn():
    return HFN_cResNet(get_builder(), Bottleneck, FoldBottleneckUBN, [False, False, True, True], [3, 4, 6, 3])

def HFN_cResNet50_2_3_4_ubn():
    return HFN_cResNet(get_builder(), Bottleneck, FoldBottleneckUBN, [False, True, True, True], [3, 4, 6, 3])

def HFN_cWideResNet50_3_4_ubn():
    return HFN_cResNet(get_builder(), Bottleneck, FoldBottleneckUBN, [False, False, True, True], [3, 4, 6, 3], wider=2)

def HFN_cResNet101_3_4_ubn():
    return HFN_cResNet(get_builder(), Bottleneck, FoldBottleneckUBN, [False, False, True, True], [3, 4, 23, 3])

def HFN_cResNet152_3_4_ubn():
    return HFN_cResNet(get_builder(), Bottleneck, FoldBottleneckUBN, [False, False, True, True], [3, 8, 36, 3])

def HFN_cResNet200_3_4_ubn():
    return HFN_cResNet(get_builder(), Bottleneck, FoldBottleneckUBN, [False, False, True, True], [3, 24, 36, 3])